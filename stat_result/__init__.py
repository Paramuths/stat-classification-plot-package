...
"""
def save_confusion_matrix(true, pred, path, data_labels, show_labels):
    cm = confusion_matrix(true, pred, data_labels)
...
if __name__=="__main__":
    ...
    data_labels = [0, 1, 2]
    show_labels = ['very good', 'good', 'bad']
    save_confusion_matrix(true, pred, data_labels, show_labels)